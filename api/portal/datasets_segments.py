...
from portal.services.dataset_service import DatasetService, DocumentService, SegmentService
...
segments_bp = Blueprint("datasets_segments_blueprint", __name__)
api = Api(segments_bp)
...
class DatasetDocumentSegmentListApi(Resource):
    ...
    def get(self, dataset_id, document_id):
        ...
        query = DocumentSegment.query.filter(
            DocumentSegment.document_id == str(document_id), DocumentSegment.tenant_id == account.current_tenant_id
        )
...
class DatasetDocumentSegmentApi(Resource):
    ...
    def patch(self, dataset_id, segment_id, action):
        ...
        segment = DocumentSegment.query.filter(
            DocumentSegment.id == str(segment_id), DocumentSegment.tenant_id == account.current_tenant_id
        ).first()
        ...
        if action == "enable":
            ...
            segment.disabled_by = account.id
            db.session.commit()
    ...
    def post(self, dataset_id, document_id):
        ...
        try:
            ...
            batch_create_segment_to_index_task.delay(
                str(job_id), result, dataset_id, document_id, account.current_tenant_id, account.id
            )
